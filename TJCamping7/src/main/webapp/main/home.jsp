    ...
    <div class="container py-5">
        ...
        <div class="packages-carousel owl-carousel">
            <c:forEach var="fvo" items="${likeList}" varStatus="s">
                <div class="packages-item">
                    <div class="packages-img">
                        <img src="https://www.bluer.co.kr${fvo.poster}" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="text-center packages-price py-2 px-4">Best</div>
                    </div>
                    <div class="packages-content bg-light">
                        <div class="p-4 pb-0">
                            <h5 class="mb-0 truncate-text">${fvo.name}</h5>
                            <p class="mb-4"></p>
                        </div>
                        <div class="row bg-primary rounded-bottom mx-0">
                            <div class="col-6 text-start px-0">
                            ...
                            <div class="col-6 text-end px-0">
                                <a href="#" class="btn-hover btn text-white py-2 px-4">${fvo.time}</a>
                            </div>
                        </div>
                    </div>
                </div>
