	...
	<table class="table">
		...
		<c:forEach var="vo" items="${noticeList }">
			<tr>
				...
				<td width="20%" class="text-center"><a
					href="../adminpage/notice_update.do?no=${vo.no }"
					class="btn btn-sm btn-success">수정</a> <a
					href="../adminpage/notice_delete.do?no=${vo.no }"
					class="btn btn-sm btn-info">삭제</a></td>
			</tr>
		...
		<tr>
			<td colspan="6" class="text-center"><a href="#"
				...
				pages <a href="#" class="btn btn-sm btn-primary">다음</a></td>
		</tr>
	</table>
</body>
</html>