...
<div class="container-fluid whitezzz"></div>
    ...
    <div class="wrapper">
            ...
            <tbody>
                ...
                <c:forEach var="vo" items="${goodsList }">
                    <tr>
                        ...
                        <td width="35%"><a href="../servicecenter/goods_detail.do?no=${vo.no }">[${vo.goods_type}]&nbsp;${vo.subject }</a></td>
                        <td width="10%" class="text-center">${vo.name }</td>
                        <td width="15%" class="text-center">${vo.dbday }</td>
                        <td width="10%" class="text-center">${vo.hit }</td>
                        <td width="20%" class="text-center">
                            <a href="../servicecenter/goods_update.do?no=${vo.no }" class="btn btn-sm btn-success">수정</a>
                            <a href="../servicecenter/goods_delete.do?no=${vo.no }" class="btn btn-sm btn-primary">삭제</a>
                        </td>
                    </tr>
        ...
        <div class="btn-container">
            <a href="../servicecenter/goods_insert.do" class="btn btn-sm btn-danger">공지등록</a>
        </div>
