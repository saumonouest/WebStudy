...
.packages-img img {
    ...
    max-height: 100%; /* 이미지의 비율을 유지하며 높이를 자동 조정 */
    display: block; /* 이미지가 요소를 블록처럼 다루도록 설정 */
    margin: 0 auto; /* 이미지가 가운데에 위치하도록 설정 */
}

.packages-item {
    max-width: 100%; /* 패키지 항목이 레이아웃을 벗어나지 않도록 제한 */
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="packages-item">
                                        <div class="packages-img">
                                            <img src="${vo.poster}" class="img-fluid w-100 rounded-top" alt="${vo.title}">
