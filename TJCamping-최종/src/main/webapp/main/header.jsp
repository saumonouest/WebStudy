                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="../campgoods/list_brand.do" class="dropdown-item">브랜드별 상품</a>
                                <a href="../campgoods/list.do?gno=3" class="dropdown-item">베스트 상품</a>
                                <a href="../campgoods/list.do?gno=4" class="dropdown-item">신상품</a>
                                <a href="../campgoods/list.do?gno=5" class="dropdown-item">세일 상품</a>
                            </div>
                        </div>
                        
                        <div class="nav-item dropdown">
                            <a href="../recipe/list.do" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            &nbsp;&nbsp;&nbsp;레시피&맛집&nbsp;&nbsp;&nbsp;</a>
                            <div class="dropdown-menu m-0">
