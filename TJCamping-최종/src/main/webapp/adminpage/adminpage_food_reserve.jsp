...
// main => javascript(window.onload=function(){})
...
$(function(){
	...
	//$('.oks').click(function(){
		...
		/*
		    ...
		    JSP => a.jsp 
		           ===== 요청 처리 (a.jsp는 메모리에 사라진다) ===> 새로운 JSP출력 
		           
		           a.jsp 
		            1) _jspInit()
		            2) _jspService() => 요청 처리 ==> 코딩 영역 
		            3) _jspDestory()
		*/
	//})
     ...
     <c:forEach var="vo" items="${recvList }">
       <tr>
	      ...
	      <td class="text-center">
	       <img src="http://www.bluer.co.kr${vo.fvo.poster }" style="width: 20px;height: 20px">
	      </td>
	      ...
	      <td class="text-center inline">
	       ...
	       <c:if test="${vo.isok=='n' }">
	        <a href="../adminpage/adminpage_food_reserve_ok.do?rno=${vo.rno }" class="btn btn-success btn-xs oks">승인대기</a>
	       </c:if>
	      </td>
       </tr>
     </c:forEach>
