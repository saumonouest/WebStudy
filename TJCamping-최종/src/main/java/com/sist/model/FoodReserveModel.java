...
public class FoodReserveModel {
	  ...
	  public String mypage_reserve(HttpServletRequest request,HttpServletResponse response)
	  {
		  ...
		  List<FoodReserveVO> list=FoodDAO.reserveMyPageData(id);
	  ...
	  {
		  List<FoodReserveVO> recvList=FoodDAO.reserveAdminPageData();
	  ...
	  public String adminpage_reserve_ok(HttpServletRequest request,HttpServletResponse response)
	  {
		  ...
		  FoodDAO.reserveOk(Integer.parseInt(frno));
	  ...
	  public String mypage_reserve_cancel(HttpServletRequest request,HttpServletResponse response)
	  {
		  String frno=request.getParameter("frno");
		  // 데이터베이스 연동 => 삭제 
		  FoodDAO.reserveCancel(Integer.parseInt(frno));
		  return "redirect:../mypage/mypage_food_reserve.do";
	  }
	  ...
	  public void mypage_food_reserve_info(HttpServletRequest request,HttpServletResponse response)
	  {
		   ...
		   */
		  FoodReserveVO vo=FoodDAO.mypageReserveInfoData(Integer.parseInt(frno));
